...
#include "buffalo/buffalo_proc_entry.h"
...
#if defined(CONFIG_ARCH_FEROCEON_MV78XX0) || defined(CONFIG_ARCH_ARMADA370)
static int
...
/* #if defined(CONFIG_ARCH_FEROCEON_KW) || defined(CONFIG_ARCH_ARMADA370) */
...
struct bf_proc_entry_tab proc_ent_tab[] = {
  ...
  {"buffalo/gpio/switch/sw_control",0,BuffaloSwPollingReadProc,BuffaloSwPollingWriteProc,NULL,     BOARD_GPP_PWR_SW},
...
#endif
#ifdef CONFIG_ARCH_FEROCEON_MV78XX0
  {"buffalo/gpio/mctrl",            1,NULL,                    NULL,	   NULL,     -1},
