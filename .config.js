...
# CONFIG_USE_REFERENCE_PCB is not set
CONFIG_BUFFALO_ERRCNT=y
CONFIG_BUFFALO_SCAN=y
# CONFIG_BUFFALO_DEGRADEKEEP is not set
# CONFIG_DEBUG_RAID is not set
...
CONFIG_BUFFALO_SUPPORT_WHITE_SPACE_ISERIAL=y
# CONFIG_BUFFALO_USE_UPS is not set
# CONFIG_BUFFALO_ENABLE_TESTCODE is not set
...
# CONFIG_MV_XORMEMCOPY is not set
# CONFIG_MV_XORMEMZERO is not set
# CONFIG_MV_USE_XOR_FOR_COPY_USER_BUFFERS is not set
CONFIG_USE_TWO_ENGINES=y
# CONFIG_USE_FOUR_ENGINES is not set
...
# CONFIG_MV_ETH_STATS_ERROR is not set
# CONFIG_MV_ETH_STATS_INFO is not set
# CONFIG_MV_ETH_STATS_DEBUG is not set
# CONFIG_MV_SNMP_STATS_DISABLE is not set
# CONFIG_MV_NF_CT_STATS_DISABLE is not set

#
# Advanced Features
#
CONFIG_MV_ETH_TIMER_PERIOD=10
CONFIG_MV_SKB_HEADROOM=16
