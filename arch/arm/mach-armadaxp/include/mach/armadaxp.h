...
#define AXP_ASM_GPP_IRQ_CAUSE_REG	(INTER_REGS_BASE + 0x18114) 	/* level interrupts for gpp cause */
#define AXP_ASM_GPP_IRQ_MID_CAUSE_REG	(INTER_REGS_BASE + 0x18154) 	/* level interrupts for gpp mid cause */
#define AXP_ASM_GPP_IRQ_HIGH_CAUSE_REG	(INTER_REGS_BASE + 0x18194) 	/* level interrupts for gpp high cause */
