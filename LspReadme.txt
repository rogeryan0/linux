...
General LSP information for NAS and GDP platforms
=================================================
...
GDP Platforms:
      ...
      ================================================================================================
	DB-88F5181-DDR1-BP		db88f5181_defconfig
	DB-88F5181-DDR2-BP		db88f5181_defconfig
	DB-88F5181-DDR2-BP-B		db88f5181_defconfig
	DB-88F5281-DDR1-BP		db88f5181_defconfig (db88f5281_vfp_defconfig for VFP support)
	DB-88F5281-DDR1-BP-A		db88f5181_defconfig (db88f5281_vfp_defconfig for VFP support)
	DB-88F5281-DDR2-BP		db88f5181_defconfig (db88f5281_vfp_defconfig for VFP support)
	DB-88F5281-DDR2-BP-A		db88f5181_defconfig (db88f5281_vfp_defconfig for VFP support)
	DB-88F5281-DDR2-BP-B		db88f5181_defconfig (db88f5281_vfp_defconfig for VFP support)
	DB-88F5281-DDR2-BP-B-FP		db88f5181_defconfig (db88f5281_vfp_defconfig for VFP support)

NAS Platforms:
	       Board			Default Configuration
      =================================================================================================
	RD-88F5181-88SX7042-2xSATA	mv88f5182_defconfig
	RD-88F5281-88SX7042-2xSATA	mv88f5182_defconfig
	DB-88F5182-DDR2-BP		mv88f5182_defconfig
	RD-88F5182-NAS-2			mv88f5182_defconfig
	RD-88F5182-NAS-3			mv88f5182_defconfig
	DB-88F5082-DDR2-BP		mv88f5082_defconfig
	RD-88F5082-NAS-3			mv88f5082_defconfig
	DB-88F6082-BP			mv88f6082_defconfig
	RD-88F6082-DAS-PLUS		mv88f6082_defconfig
	RD-88F6082-NAS			mv88f6082_defconfig


2.  Marvell LSP File locations
-------------------------------
    o  Marvell LSP base directory: 
       - /arch/arm/mach-feroceon/...

    o  Linux specific code and drivers:  
       - /arch/arm/mach-feroceon/LSP/...

    o  Marvell SoC H/W Abstraction Layer (OS independent):
       - /arch/arm/mach-feroceon/Soc/....

    o  Marvell Board H/W Abstraction Layer
       - /arch/arm/mach-feroceon/Board/...


3.  Procedure for Porting a new Customer Board
-----------------------------------------------
The following are the steps for porting a new customer board to the Marvell
LSP:

    o Add the Board Specific configuration definitions:
	File location: ~/arch/arm/mach-feroceon/Board/boardEnv/mvCustomerBoardEnv.h
	...
	File location: ~/arch/arm/mach-feroceon/Board/boardEnv/mvCustomerBoardEnv.c
	...
	File location: ~/arch/arm/mach-feroceon/LSP/sysmap.c
...
The map driver is found under: ~/arch/arm/mach-feroceon/LSP/sysmap.c
...
The Ethernet driver is found under ~/arch/arm/mach-feroceon/LSP/mv_ethernet/
...
The Linux driver is found under: ~/arch/arm/mach-feroceon/LSP/mvSata/
...
In order to operate as "Mass Storage Device" the following steps should be followed:
	...
	- Insert the Marvell USB gadget driver: "insmod mv_usb_gadget.ko"
...
This feature is supported for platforms with RTC on-board. The driver is found under 
~/arch/arm/mach-feroceon/LSP/time.c
To read the date and time from the RTC (over I2C), use the command "hwclock".
...
OpenSSL
-------
o  Refer to cesa/openssl/README

IPsec
-----
o  Refer to cesa/openswan/README
...
----------------------
    ...
    o  Runtime debugging is supported through the /proc virtual FS.
       See ~/arch/arm/mach-feroceon/LSP/proc.c
